...
// const GameDesc = () => {
//   return (
//     <div className="flex flex-col items-center justify-center min-h-screen p-6 transition-colors duration-500"  style={{ backgroundColor: "var(--bg-app)" }}
...
const GameDesc = () => {
  return (
    /* The outer container now uses --bg-app from your theme */
    <div className="flex flex-col items-center justify-center min-h-screen p-6 transition-colors duration-500" 
         style={{ backgroundColor: "var(--bg-app)" }}>
      
      {/* The card uses theme-aware card background and borders */}
      <div className="card-primary max-w-4xl p-8 rounded-2xl shadow-lg border-2"
           style={{ 
        ...
        <h1 className="text-4xl font-bold text-center mb-4"
          ...
          🃏 Veilbound: The Pact of Suits
          Active Theme: {document.body.className || 'None (Default)'}
        </h1>
        ...
        <section className="mb-6">
          <h2 className="text-2xl text-bold mb-2" style={{ color: "var(--accent-primary)" }}>
            🎯 Objective
          </h2>
          <p>
            Outwit your rivals by accurately predicting and winning hands. The
            player with the highest cumulative score becomes the{" "}
        ...
        {/* ... Player Setup and Game Components Sections ... */}
           <section className="mb-6">
          <h2
            className="text-2xl text-bold mb-2"
            style={{ color: "var(--accent-primary)" }}
        ...
        <section className="mb-6">
          ...
          {/* Table uses the theme-aware border and background */}
          <table className="w-full border text-center rounded-lg overflow-hidden shadow-md" 
                 style={{ borderColor: "var(--border-color)" }}>
            <thead style={{ backgroundColor: "var(--border-color)", color: "white" }}>
              <tr>
                <th className="p-2 border">Prediction</th>
                <th className="p-2 border">Outcome</th>
                <th className="p-2 border">Score</th>
        ...
        <section>
          <h2 className="text-2xl text-bold mb-2" style={{ color: "var(--accent-primary)" }}>
            🕯️ Theme Flavor: The Orders
          </h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <span className="font-bold" style={{ color: "var(--theme-arcade-pink)" }}>Hearts ♥️ :</span> Masters of deception.
            </li>
            <li>
              <span className="font-bold" style={{ color: "var(--theme-arcade-red)" }}>Spades ♠️:</span> Ruthless tacticians.
            </li>
            <li>
              <span className="font-bold" style={{ color: "var(--theme-arcade-yellow)" }}>Diamonds ♦️:</span> Traders of fate.
            </li>
            <li>
              <span className="font-bold" style={{ color: "var(--theme-arcade-blue)" }}>Clubs ♣️:</span> Agents of entropy.
            </li>
          </ul>
        </section>
      </div>
